...
int drawSFMLMap() {
    sf::RenderWindow window(sf::VideoMode({800, 600}), "SFML Route Planner");
...
int main() {
    ...
    std::cout << "Map Loaded. Opening GUI..." << std::endl;
    RoutePlanner::displaySFML(myMap); // GUI takes over control here
...
//             RoutePlanner::displaySFML(myMap, result.path);
//         } else {
